...
class PromoteToSuperuserCommandTests(BaseTestCase):
    """``promotetosuperuser`` promotes an existing user (by email) to superuser+staff.
    ...
    def test_promotes_matching_user(self) -> None:
        ...
        call_command("promotetosuperuser", "alice@example.com", stdout=StringIO())
    ...
    def test_email_match_is_case_insensitive(self) -> None:
        ...
        call_command("promotetosuperuser", "BOB@example.com", stdout=StringIO())
    ...
    def test_already_superuser_is_noop(self) -> None:
        ...
        call_command("promotetosuperuser", "root@example.com", stdout=StringIO())
