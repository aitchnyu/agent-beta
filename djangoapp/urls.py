...
from djangoapp.views.notifications import notifications_api
...
urlpatterns = [
    ...
    # app has no framework-prefixed routes, so it never shadows other routes.
